    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors">
      <div className="bg-navy-950 dark:bg-slate-900 py-16 transition-colors">
        <div className="container-page">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-slate-300 dark:text-slate-400">Effective Date: August 2026</p>
          </div>
        </div>
      </div>
      ...
      <div className="container-page py-12">
        <div className="max-w-3xl mx-auto bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-8 md:p-12 space-y-8 transition-colors">
          ...
          <div className="p-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/40 rounded-lg flex items-start gap-3 transition-colors">
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">4. No Professional Advice</h2>
            <div className="p-4 bg-red-50 dark:bg-red-950/30 border border-red-100 dark:border-red-900/40 rounded-lg transition-colors">
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">5. Intellectual Property</h2>
            <div className="flex items-start gap-3">
              <Copyright className="h-5 w-5 text-navy-600 dark:text-dutch-400 mt-0.5" />
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">6. User Content</h2>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">7. Termination</h2>
            <div className="flex items-start gap-3">
              <Ban className="h-5 w-5 text-navy-600 dark:text-dutch-400 mt-0.5" />
              <div className="text-slate-600 dark:text-slate-400">
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">8. Changes to Terms</h2>
            <div className="flex items-start gap-3">
              <RefreshCw className="h-5 w-5 text-navy-600 dark:text-dutch-400 mt-0.5" />
              <div className="text-slate-600 dark:text-slate-400">
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-3">9. Contact Us</h2>
            <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-lg transition-colors">
              <BookOpen className="h-5 w-5 text-dutch-600 dark:text-dutch-400" />
              <span className="text-slate-700 dark:text-slate-300">Questions about these Terms? Contact us at: hello@nlstudyhub.com</span>
            </div>
          </section>
