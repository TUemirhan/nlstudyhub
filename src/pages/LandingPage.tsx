...
export function LandingPage() {
  ...
  // REAL DEADLINE CALCULATION - Always returns the next upcoming deadline
  ...
  // Numerus Fixus: 15 January (for September intake)
  const numerusFixus = getNextDeadline(1, 15);
  // Student housing: typically opens 1 March for September intake
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/90 dark:bg-slate-950/90 backdrop-blur border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="container-page mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Middle: Features Dropdown + How It Works */}
            <nav className="hidden md:flex items-center gap-1">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showFeaturesDropdown && (
                  <div className="absolute top-full left-0 mt-2 w-80 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
            ...
            {/* Right: Background Toggle + Auth Buttons */}
          ...
          {mobileOpen && (
            <div className="md:hidden pb-6 pt-2 space-y-2 border-t border-slate-200 dark:border-slate-800">
              <button
                ...
                className="block w-full text-left px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-200"
              >
                Features
              </button>
              <button
              ...
              <div className="pt-3 flex items-center gap-3 border-t border-slate-200 dark:border-slate-800">
                ...
                <button
                  onClick={() => { setIsSignUp(false); setShowAuth(true); setMobileOpen(false); }}
                  className="flex-1 text-sm font-semibold text-left px-3 py-2 text-slate-700 dark:text-white"
                >
                  Sign In
                </button>
                <button
                  onClick={() => { setIsSignUp(true); setShowAuth(true); setMobileOpen(false); }}
                  className="flex-1 text-sm font-bold text-center px-3 py-2 bg-dutch-500 hover:bg-dutch-600 text-white rounded-xl shadow-lg shadow-dutch-500/25 transition-all"
                >
                  Get Started
                </button>
              </div>
      ...
      {/* Hero with Amsterdam Canal Background */}
        ...
        <div className="container-page relative z-10 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
              ...
              <span className="text-dutch-400">studying in the Netherlands</span>
            </h1>
            
            <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
              Navigate visas, IND financial proof, English-taught programs, and deadlines with confidence. 
              Join 10,000+ students who found their path to Dutch universities.
            </p>
        ...
        <div className="container-page">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              From visa paperwork to university deadlines, we've mapped out every step of your journey.
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-24 bg-white dark:bg-slate-950">
        <div className="container-page max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-navy-900 dark:text-white mb-16">Get your roadmap in 3 minutes</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: '01', icon: UserPlus, title: 'Create Free Account', desc: 'Tell us your nationality and target degree', color: 'bg-blue-500' },
              { step: '02', icon: Map, title: 'Get Your Roadmap', desc: 'Receive personalized visa and application timeline', color: 'bg-dutch-500' },
              { step: '03', icon: CheckCircle2, title: 'Track Progress', desc: 'Mark steps complete and get deadline reminders', color: 'bg-green-500' }
            ].map((item, idx) => {
              const Icon = item.icon;
              return (
                <div key={idx} className="relative bg-slate-50 dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800">
                  <div className={`absolute -top-4 left-8 ${item.color} text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg`}>
                    Step {item.step}
                  </div>
                  <div className="h-16 w-16 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center mb-6 mt-2 shadow-sm">
                    <Icon className="h-8 w-8 text-navy-700 dark:text-slate-300" />
                  </div>
                  <h3 className="text-xl font-bold text-navy-900 dark:text-white mb-2">{item.title}</h3>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-md w-full p-8 relative shadow-2xl">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-slate-900 text-slate-500">Or email</span>
              </div>
            </div>
